			...
			<div class="baris">
				<div class="selamat-datang">
					<div class="col-header">
						<h2 class="judul-md">Daftar Makanan Hewan</h2>
               </div>
               
					<div class="col-header txt-right">
						<a href="<?=url('paket/pkt_dc/tambah.php')?>" class="btn-lg bg-primary">+ Tambah Barang</a>
					</div>	
				</div>
			</div>
								...
								<table class="tabel-transaksi">
									<thead>
										<tr>
											...
											<th class="sticky">Nama Makanan</th>
											<th class="sticky">Jenis</th>
											<th class="sticky">Berat</th>
