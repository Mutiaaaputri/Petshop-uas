			...
			<div class="baris">
				<div class="selamat-datang">
					<div class="col-header">
						<h2 class="judul-md">Grooming</h2>
               </div>
               
					<div class="col-header txt-right">
						<a href="<?=url('paket/pkt_cs/tambah.php')?>" class="btn-lg bg-primary">+ Tambah Barang</a>
					</div>	
				</div>
			</div>
								...
								<table class="tabel-transaksi">
									<thead>
										<tr>
											...
											<th class="sticky">Jenis</th>
											<th class="sticky" style="text-align: center;">Kategori</th>
