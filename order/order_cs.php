   ...
   <?php if (order_cs($_POST) > 0) :?>
      ...
      <div class="box">
         <img src="<?=url('_assets/img/berhasil.png')?>" height="68" alt="alert sukses">
            ...
            <button onclick="window.location='http://localhost/Petshop/'" class="btn-alert">Ok</button>
         </div>
      </div>
   <?php else : ?>
      <div class="alert">
                     ...
                     <form action="" method="post">
                        <div class="row-input">
                           ...
                           <div class="col-form m-1">
                              ...
                              <div class="form-grup">
                                 <label for="tgl_order_msk">Tanggal Masuk</label>
                                 <input type="date" name="tgl_masuk_cs" autocomplete="off" id="tgl_order_msk">
                              </div>

                              <div class="form-grup">
                                 <label for="tgl_order_klr">Tanggal Keluar</label>
