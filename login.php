...
<head>
	...
	<title>Pussy Petshop | Login</title>
...
<body>
	...
	<?php if (isset($_SESSION['login']) && isset($_SESSION['master'])) : ?>
		<script>window.location='http://localhost/Petshop/'</script>
	<?php endif ?> 
	...
	<div class="box">
		<div class="box-content">
			<div class="col box__left">
				<div class="logo">
					<img src="<?= url('_assets/img/Logo.png') ?>" alt="">
				</div>
			...
			<div class="col box__right">
				<div class="box__right-content">
					<div class="text__right">
						<h1>Admin Pengadaan</h1>
					</div>

					<img src=" <?=url('_assets/img/orang.png')?>" alt="" class="box-img-orang">
					<img src=" <?=url('_assets/img/dog.png')?>" alt="" class="box-img-celana">
					<img src=" <?=url('_assets/img/food.png')?>" alt="" class="box-img-kaos">
					<img src=" <?=url('_assets/img/cat.png')?>" alt="" class="box-img-kemeja">
	...
	<div class="copyright">
		<p>&copy; <span id="tahun"></span> Pussy Petshop.</p>
		<script>
